...
use Psr\Log\LoggerInterface; //path to controller
...
class SongController extends AbstractController { 
    ...
    #[Route('/api/songs/{id<\d+>}', methods: ['GET'],name:'api_songs_get_one') ] //get request to API endpoint, regular expression here to use integer of any length
